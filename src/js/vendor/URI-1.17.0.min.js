...
/* build contains: IPv6.js, punycode.js, SecondLevelDomains.js, URI-1.17.0.min.js, URITemplate.js */
(function(f,h){"object"===typeof exports?module.exports=h():"function"===typeof define&&define.amd?define(h):f.IPv6=h(f)})(this,function(f){var h=f&&f.IPv6;return{best:function(g){g=g.toLowerCase().split(":");var l=g.length,b=8;""===g[0]&&""===g[1]&&""===g[2]?(g.shift(),g.shift()):""===g[0]&&""===g[1]?g.shift():""===g[l-1]&&""===g[l-2]&&g.pop();l=g.length;-1!==g[l-1].indexOf(".")&&(b=7);var k;for(k=0;k<l&&""!==g[k];k++);if(k<b)for(g.splice(k,1,"0000");g.length<b;)g.splice(k,0,"0000");for(k=0;k<b;k++){for(var l=
	                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  g[k].split(""),f=0;3>f;f++)if("0"===l[0]&&1<l.length)l.splice(0,1);else break;g[k]=l.join("")}var l=-1,h=f=0,n=-1,t=!1;for(k=0;k<b;k++)t?"0"===g[k]?h+=1:(t=!1,h>f&&(l=n,f=h)):"0"===g[k]&&(t=!0,n=k,h=1);h>f&&(l=n,f=h);1<f&&g.splice(l,f,"");l=g.length;b="";""===g[0]&&(b=":");for(k=0;k<l;k++){b+=g[k];if(k===l-1)break;b+=":"}""===g[l-1]&&(b+=":");return b},noConflict:function(){f.IPv6===this&&(f.IPv6=h);return this}}});
(function(f){function h(b){throw RangeError(e[b]);}function g(b,e){for(var n=b.length;n--;)b[n]=e(b[n]);return b}function l(b,e){return g(b.split(z),e).join(".")}function b(b){for(var e=[],n=0,g=b.length,f,a;n<g;)f=b.charCodeAt(n++),55296<=f&&56319>=f&&n<g?(a=b.charCodeAt(n++),56320==(a&64512)?e.push(((f&1023)<<10)+(a&1023)+65536):(e.push(f),n--)):e.push(f);return e}function k(b){return g(b,function(b){var e="";65535<b&&(b-=65536,e+=w(b>>>10&1023|55296),b=56320|b&1023);return e+=w(b)}).join("")}function B(b,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               e){return b+22+75*(26>b)-((0!=e)<<5)}function v(b,e,n){var g=0;b=n?q(b/700):b>>1;for(b+=q(b/e);455<b;g+=36)b=q(b/35);return q(g+36*b/(b+38))}function n(b){var e=[],n=b.length,g,f=0,a=128,c=72,d,m,x,y,l;d=b.lastIndexOf("-");0>d&&(d=0);for(m=0;m<d;++m)128<=b.charCodeAt(m)&&h("not-basic"),e.push(b.charCodeAt(m));for(d=0<d?d+1:0;d<n;){m=f;g=1;for(x=36;;x+=36){d>=n&&h("invalid-input");y=b.charCodeAt(d++);y=10>y-48?y-22:26>y-65?y-65:26>y-97?y-97:36;(36<=y||y>q((2147483647-f)/g))&&h("overflow");f+=y*g;l=
	x<=c?1:x>=c+26?26:x-c;if(y<l)break;y=36-l;g>q(2147483647/y)&&h("overflow");g*=y}g=e.length+1;c=v(f-m,g,0==m);q(f/g)>2147483647-a&&h("overflow");a+=q(f/g);f%=g;e.splice(f++,0,a)}return k(e)}function t(e){var g,n,f,l,a,c,d,m,x,y=[],t,k,p;e=b(e);t=e.length;g=128;n=0;a=72;for(c=0;c<t;++c)x=e[c],128>x&&y.push(w(x));for((f=l=y.length)&&y.push("-");f<t;){d=2147483647;for(c=0;c<t;++c)x=e[c],x>=g&&x<d&&(d=x);k=f+1;d-g>q((2147483647-n)/k)&&h("overflow");n+=(d-g)*k;g=d;for(c=0;c<t;++c)if(x=e[c],x<g&&2147483647<
	++n&&h("overflow"),x==g){m=n;for(d=36;;d+=36){x=d<=a?1:d>=a+26?26:d-a;if(m<x)break;p=m-x;m=36-x;y.push(w(B(x+p%m,0)));m=q(p/m)}y.push(w(B(m,0)));a=v(n,k,f==l);n=0;++f}++n;++g}return y.join("")}var C="object"==typeof exports&&exports,E="object"==typeof module&&module&&module.exports==C&&module,D="object"==typeof global&&global;if(D.global===D||D.window===D)f=D;var u,p=/^xn--/,r=/[^ -~]/,z=/\x2E|\u3002|\uFF0E|\uFF61/g,e={overflow:"Overflow: input needs wider integers to process","not-basic":"Illegal input >= 0x80 (not a basic code point)",
	"invalid-input":"Invalid input"},q=Math.floor,w=String.fromCharCode,A;u={version:"1.2.3",ucs2:{decode:b,encode:k},decode:n,encode:t,toASCII:function(b){return l(b,function(b){return r.test(b)?"xn--"+t(b):b})},toUnicode:function(b){return l(b,function(b){return p.test(b)?n(b.slice(4).toLowerCase()):b})}};if("function"==typeof define&&"object"==typeof define.amd&&define.amd)define(function(){return u});else if(C&&!C.nodeType)if(E)E.exports=u;else for(A in u)u.hasOwnProperty(A)&&(C[A]=u[A]);else f.punycode=
	u})(this);
...
(function(f,h){"object"===typeof exports?module.exports=h(require("./punycode"),require("./IPv6"),require("./SecondLevelDomains")):"function"===typeof define&&define.amd?define(["./punycode","./IPv6","./SecondLevelDomains"],h):f.URI=h(f.punycode,f.IPv6,f.SecondLevelDomains,f)})(this,function(f,h,g,l){function b(a,c){var d=1<=arguments.length,m=2<=arguments.length;if(!(this instanceof b))return d?m?new b(a,c):new b(a):new b;if(void 0===a){if(d)throw new TypeError("undefined is not a valid argument for URI");
	a="undefined"!==typeof location?location.href+"":""}this.href(a);return void 0!==c?this.absoluteTo(c):this}function k(a){return a.replace(/([.*+?^=!:${}()|[\]\/\\])/g,"\\$1")}function B(a){return void 0===a?"Undefined":String(Object.prototype.toString.call(a)).slice(8,-1)}function v(a){return"Array"===B(a)}function n(a,c){var d={},b,e;if("RegExp"===B(c))d=null;else if(v(c))for(b=0,e=c.length;b<e;b++)d[c[b]]=!0;else d[c]=!0;b=0;for(e=a.length;b<e;b++)if(d&&void 0!==d[a[b]]||!d&&c.test(a[b]))a.splice(b,
	1),e--,b--;return a}function t(a,c){var d,b;if(v(c)){d=0;for(b=c.length;d<b;d++)if(!t(a,c[d]))return!1;return!0}var e=B(c);d=0;for(b=a.length;d<b;d++)if("RegExp"===e){if("string"===typeof a[d]&&a[d].match(c))return!0}else if(a[d]===c)return!0;return!1}function C(a,c){if(!v(a)||!v(c)||a.length!==c.length)return!1;a.sort();c.sort();for(var d=0,b=a.length;d<b;d++)if(a[d]!==c[d])return!1;return!0}function E(a){return a.replace(/^\/+|\/+$/g,"")}function D(a){return escape(a)}function u(a){return encodeURIComponent(a).replace(/[!'()*]/g,
	D).replace(/\*/g,"%2A")}function p(a){return function(c,d){if(void 0===c)return this._parts[a]||"";this._parts[a]=c||null;this.build(!d);return this}}function r(a,c){return function(d,b){if(void 0===d)return this._parts[a]||"";null!==d&&(d+="",d.charAt(0)===c&&(d=d.substring(1)));this._parts[a]=d;this.build(!b);return this}}var z=l&&l.URI;b.version="1.17.0";var e=b.prototype,q=Object.prototype.hasOwnProperty;b._parts=function(){return{protocol:null,username:null,password:null,hostname:null,urn:null,
	...
	b.find_uri_expression=/\b((?:[a-z][\w-]+:(?:\/{1,3}|[a-z0-9%])|www\d{0,3}[.]|[a-z0-9.\-]+[.][a-z]{2,4}\/)(?:[^\s()<>]+|\(([^\s()<>]+|(\([^\s()<>]+\)))*\))+(?:\(([^\s()<>]+|(\([^\s()<>]+\)))*\)|[^\s`!()\[\]{};:'".,<>?\u00ab\u00bb\u201c\u201d\u2018\u2019]))/ig;b.findUri={start:/\b(?:([a-z][a-z0-9.+-]*:\/\/)|www\.)/gi,end:/[\s\r\n]|$/,trim:/[`!()\[\]{};:'".,<>?\u00ab\u00bb\u201c\u201d\u201e\u2018\u2019]+$/};b.defaultPorts={http:"80",https:"443",ftp:"21",gopher:"70",ws:"80",wss:"443"};b.invalid_hostname_characters=
		...
		"%20"):a)}catch(d){return a}};var w={encode:"encode",decode:"decode"},A,F=function(a,c){return function(d){try{return b[c](d+"").replace(b.characters[a][c].expression,function(d){return b.characters[a][c].map[d]})}catch(m){return d}}};for(A in w)b[A+"PathSegment"]=F("pathname",w[A]),b[A+"UrnPathSegment"]=F("urnpath",w[A]);w=function(a,c,d){return function(m){var e;e=d?function(a){return b[c](b[d](a))}:b[c];m=(m+"").split(a);for(var f=0,g=m.length;f<g;f++)m[f]=e(m[f]);return m.join(a)}};b.decodePath=
	...
	-1<d&&(c.protocol=a.substring(0,d)||null,c.protocol&&!c.protocol.match(b.protocol_expression)?c.protocol=void 0:"//"===a.substring(d+1,d+3)?(a=a.substring(d+3),a=b.parseAuthority(a,c)):(a=a.substring(d+1),c.urn=!0)));c.path=a;return c};b.parseHost=function(a,c){a=a.replace(/\\/g,"/");var d=a.indexOf("/"),b;-1===d&&(d=a.length);if("["===a.charAt(0))b=a.indexOf("]"),c.hostname=a.substring(1,b)||null,c.port=a.substring(b+2,d)||null,"/"===c.port&&(c.port=null);else{var e=a.indexOf(":");b=a.indexOf("/");
		...
		d.shift(),c.password=d[0]?b.decode(d.join(":")):null,a=a.substring(m+1)):(c.username=null,c.password=null);return a};b.parseQuery=function(a,c){if(!a)return{};a=a.replace(/&+/g,"&").replace(/^\?*&*|&+$/g,"");if(!a)return{};for(var d={},m=a.split("&"),e=m.length,f,g,n=0;n<e;n++)if(f=m[n].split("="),g=b.decodeQuery(f.shift(),c),f=f.length?b.decodeQuery(f.join("="),c):null,q.call(d,g)){if("string"===typeof d[g]||null===d[g])d[g]=[d[g]];d[g].push(f)}else d[g]=f;return d};b.build=function(a){var c="";
		...
		function(a){return b.buildUserinfo(a)+b.buildHost(a)};b.buildUserinfo=function(a){var c="";a.username&&(c+=b.encode(a.username),a.password&&(c+=":"+b.encode(a.password)),c+="@");return c};b.buildQuery=function(a,c,d){var m="",e,f,g,n;for(f in a)if(q.call(a,f)&&f)if(v(a[f]))for(e={},g=0,n=a[f].length;g<n;g++)void 0!==a[f][g]&&void 0===e[a[f][g]+""]&&(m+="&"+b.buildQueryParameter(f,a[f][g],d),!0!==c&&(e[a[f][g]+""]=!0));else void 0!==a[f]&&(m+="&"+b.buildQueryParameter(f,a[f],d));return m.substring(1)};
	b.buildQueryParameter=function(a,c,d){return b.encodeQuery(a,d)+(null!==c?"="+b.encodeQuery(c,d):"")};b.addQuery=function(a,c,d){if("object"===typeof c)for(var m in c)q.call(c,m)&&b.addQuery(a,m,c[m]);else if("string"===typeof c)void 0===a[c]?a[c]=d:("string"===typeof a[c]&&(a[c]=[a[c]]),v(d)||(d=[d]),a[c]=(a[c]||[]).concat(d));else throw new TypeError("URI.addQuery() accepts an object, string as the name parameter");};b.removeQuery=function(a,c,d){var m;if(v(c))for(d=0,m=c.length;d<m;d++)a[c[d]]=
		void 0;else if("RegExp"===B(c))for(m in a)c.test(m)&&(a[m]=void 0);else if("object"===typeof c)for(m in c)q.call(c,m)&&b.removeQuery(a,m,c[m]);else if("string"===typeof c)void 0!==d?"RegExp"===B(d)?!v(a[c])&&d.test(a[c])?a[c]=void 0:a[c]=n(a[c],d):a[c]!==String(d)||v(d)&&1!==d.length?v(a[c])&&(a[c]=n(a[c],d)):a[c]=void 0:a[c]=void 0;else throw new TypeError("URI.removeQuery() accepts an object, string, RegExp as the first parameter");};b.hasQuery=function(a,c,d,m){if("object"===typeof c){for(var e in c)if(q.call(c,
			e)&&!b.hasQuery(a,e,c[e]))return!1;return!0}if("string"!==typeof c)throw new TypeError("URI.hasQuery() accepts an object, string as the name parameter");switch(B(d)){case "Undefined":return c in a;case "Boolean":return a=!(v(a[c])?!a[c].length:!a[c]),d===a;case "Function":return!!d(a[c],c,a);case "Array":return v(a[c])?(m?t:C)(a[c],d):!1;case "RegExp":return v(a[c])?m?t(a[c],d):!1:!(!a[c]||!a[c].match(d));case "Number":d=String(d);case "String":return v(a[c])?m?t(a[c],d):!1:a[c]===d;default:throw new TypeError("URI.hasQuery() accepts undefined, boolean, string, number, RegExp, Function as the value parameter");
	}};b.commonPath=function(a,c){var d=Math.min(a.length,c.length),b;for(b=0;b<d;b++)if(a.charAt(b)!==c.charAt(b)){b--;break}if(1>b)return a.charAt(0)===c.charAt(0)&&"/"===a.charAt(0)?"/":"";if("/"!==a.charAt(b)||"/"!==c.charAt(b))b=a.substring(0,b).lastIndexOf("/");return a.substring(0,b+1)};b.withinString=function(a,c,d){d||(d={});var e=d.start||b.findUri.start,f=d.end||b.findUri.end,g=d.trim||b.findUri.trim,n=/[a-z0-9-]=["']?$/i;for(e.lastIndex=0;;){var t=e.exec(a);if(!t)break;t=t.index;if(d.ignoreHtml){var k=
		                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 a.slice(Math.max(t-3,0),t);if(k&&n.test(k))continue}var k=t+a.slice(t).search(f),h=a.slice(t,k).replace(g,"");d.ignore&&d.ignore.test(h)||(k=t+h.length,h=c(h,t,k,a),a=a.slice(0,t)+h+a.slice(k),e.lastIndex=t+h.length)}e.lastIndex=0;return a};b.ensureValidHostname=function(a){if(a.match(b.invalid_hostname_characters)){if(!f)throw new TypeError('Hostname "'+a+'" contains characters other than [A-Z0-9.-] and Punycode.js is not available');if(f.toASCII(a).match(b.invalid_hostname_characters))throw new TypeError('Hostname "'+
		a+'" contains characters other than [A-Z0-9.-]');}};b.noConflict=function(a){if(a)return a={URI:this.noConflict()},l.URITemplate&&"function"===typeof l.URITemplate.noConflict&&(a.URITemplate=l.URITemplate.noConflict()),l.IPv6&&"function"===typeof l.IPv6.noConflict&&(a.IPv6=l.IPv6.noConflict()),l.SecondLevelDomains&&"function"===typeof l.SecondLevelDomains.noConflict&&(a.SecondLevelDomains=l.SecondLevelDomains.noConflict()),a;l.URI===this&&(l.URI=z);return this};e.build=function(a){if(!0===a)this._deferred_build=
		!0;else if(void 0===a||this._deferred_build)this._string=b.build(this._parts),this._deferred_build=!1;return this};e.clone=function(){return new b(this)};e.valueOf=e.toString=function(){return this.build(!1)._string};e.protocol=p("protocol");e.username=p("username");e.password=p("password");e.hostname=p("hostname");e.port=p("port");e.query=r("query","?");e.fragment=r("fragment","#");e.search=function(a,c){var d=this.query(a,c);return"string"===typeof d&&d.length?"?"+d:d};e.hash=function(a,c){var d=
		...
		a.path||a.pathname);a.nodeName&&(f=b.getDomAttribute(a),a=a[f]||"",f=!1);!e&&f&&void 0!==a.pathname&&(a=a.toString());if("string"===typeof a||a instanceof String)this._parts=b.parse(String(a),this._parts);else if(e||f)for(d in e=e?a._parts:a,e)q.call(this._parts,d)&&(this._parts[d]=e[d]);else throw new TypeError("invalid input");this.build(!c);return this};e.is=function(a){var c=!1,d=!1,e=!1,f=!1,n=!1,t=!1,k=!1,h=!this._parts.urn;this._parts.hostname&&(h=!1,d=b.ip4_expression.test(this._parts.hostname),
		e=b.ip6_expression.test(this._parts.hostname),c=d||e,n=(f=!c)&&g&&g.has(this._parts.hostname),t=f&&b.idn_expression.test(this._parts.hostname),k=f&&b.punycode_expression.test(this._parts.hostname));switch(a.toLowerCase()){case "relative":return h;case "absolute":return!h;case "domain":case "name":return f;case "sld":return n;case "ip":return c;case "ip4":case "ipv4":case "inet4":return d;case "ip6":case "ipv6":case "inet6":return e;case "idn":return t;case "url":return!this._parts.urn;case "urn":return!!this._parts.urn;
		...
		a+'" contains characters other than [0-9]');return H.call(this,a,c)};e.hostname=function(a,c){if(this._parts.urn)return void 0===a?"":this;if(void 0!==a){var d={};if("/"!==b.parseHost(a,d))throw new TypeError('Hostname "'+a+'" contains characters other than [A-Z0-9.-]');a=d.hostname}return I.call(this,a,c)};e.origin=function(a,c){if(this._parts.urn)return void 0===a?"":this;if(void 0===a){var d=this.protocol();return this.authority()?(d?d+"://":"")+this.authority():""}d=b(a);this.protocol(d.protocol()).authority(d.authority()).build(!c);
		return this};e.host=function(a,c){if(this._parts.urn)return void 0===a?"":this;if(void 0===a)return this._parts.hostname?b.buildHost(this._parts):"";if("/"!==b.parseHost(a,this._parts))throw new TypeError('Hostname "'+a+'" contains characters other than [A-Z0-9.-]');this.build(!c);return this};e.authority=function(a,c){if(this._parts.urn)return void 0===a?"":this;if(void 0===a)return this._parts.hostname?b.buildAuthority(this._parts):"";if("/"!==b.parseAuthority(a,this._parts))throw new TypeError('Hostname "'+
	...
	e.readable=function(){var a=this.clone();a.username("").password("").normalize();var c="";a._parts.protocol&&(c+=a._parts.protocol+"://");a._parts.hostname&&(a.is("punycode")&&f?(c+=f.toUnicode(a._parts.hostname),a._parts.port&&(c+=":"+a._parts.port)):c+=a.host());a._parts.hostname&&a._parts.path&&"/"!==a._parts.path.charAt(0)&&(c+="/");c+=a.path(!0);if(a._parts.query){for(var d="",e=0,g=a._parts.query.split("&"),n=g.length;e<n;e++){var t=(g[e]||"").split("="),d=d+("&"+b.decodeQuery(t[0],this._parts.escapeQuerySpace).replace(/&/g,
		...
		e=e.path.substring(f.length).replace(/[^\/]*$/,"").replace(/.*?\//g,"../");d.path=e+d.path.substring(f.length)||"./";return c.build()};e.equals=function(a){var c=this.clone();a=new b(a);var d={},e={},f={},g;c.normalize();a.normalize();if(c.toString()===a.toString())return!0;d=c.query();e=a.query();c.query("");a.query("");if(c.toString()!==a.toString()||d.length!==e.length)return!1;d=b.parseQuery(d,this._parts.escapeQuerySpace);e=b.parseQuery(e,this._parts.escapeQuerySpace);for(g in d)if(q.call(d,
			g)){if(!v(d[g])){if(d[g]!==e[g])return!1}else if(!C(d[g],e[g]))return!1;f[g]=!0}for(g in e)if(q.call(e,g)&&!f[g])return!1;return!0};e.duplicateQueryParameters=function(a){this._parts.duplicateQueryParameters=!!a;return this};e.escapeQuerySpace=function(a){this._parts.escapeQuerySpace=!!a;return this};return b});
(function(f,h){"object"===typeof exports?module.exports=h(require("./URI")):"function"===typeof define&&define.amd?define(["./URI-1.17.0.min"],h):f.URITemplate =h(f.URI,f)})(this,function( f, h){function g( b){if(g._cache[b])return g._cache[b];if(!(this instanceof g))return new g(b);this.expression =b;g._cache[b] =this;return this}function l( b){this.data =b;this.cache ={}}var b =h&&h.URITemplate, k =Object.prototype.hasOwnProperty, B =g.prototype, v ={"":{prefix:"",separator:",",named:!1,empty_name_separator:!1,encode:"encode"},
	"+"                                                                                                                                                                                                                                                                                                                                                                                                                                                                    :{prefix:"",separator:",",named:!1,empty_name_separator:!1,encode:"encodeReserved"},"#":{prefix:"#",separator:",",named:!1,empty_name_separator:!1,encode:"encodeReserved"},".":{prefix:".",separator:".",named:!1,empty_name_separator:!1,encode:"encode"},"/":{prefix:"/",separator:"/",named:!1,empty_name_separator:!1,encode:"encode"},";":{prefix:";",separator:";",named:!0,empty_name_separator:!1,encode:"encode"},"?":{prefix:"?",separator:"&",named:!0,empty_name_separator:!0,encode:"encode"},"&":{prefix:"&",
		separator:"&",named:!0,empty_name_separator:!0,encode:"encode"}};g._cache={};g.EXPRESSION_PATTERN=/\{([^a-zA-Z0-9%_]?)([^\}]+)(\}|$)/g;g.VARIABLE_PATTERN=/^([^*:]+)((\*)|:(\d+))?$/;g.VARIABLE_NAME_PATTERN=/[^a-zA-Z0-9%_]/;g.expand=function(b,f){var k=v[b.operator],h=k.named?"Named":"Unnamed",l=b.variables,u=[],p,r,z;for(z=0;r=l[z];z++)p=f.get(r.name),p.val.length?u.push(g["expand"+h](p,k,r.explode,r.explode&&k.separator||",",r.maxlength,r.name)):p.type&&u.push("");return u.length?k.prefix+u.join(k.separator):
	""};g.expandNamed=function(b,g,k,h,l,u){var p="",r=g.encode;g=g.empty_name_separator;var v=!b[r].length,e=2===b.type?"":f[r](u),q,w,A;w=0;for(A=b.val.length;w<A;w++)l?(q=f[r](b.val[w][1].substring(0,l)),2===b.type&&(e=f[r](b.val[w][0].substring(0,l)))):v?(q=f[r](b.val[w][1]),2===b.type?(e=f[r](b.val[w][0]),b[r].push([e,q])):b[r].push([void 0,q])):(q=b[r][w][1],2===b.type&&(e=b[r][w][0])),p&&(p+=h),k?p+=e+(g||q?"=":"")+q:(w||(p+=f[r](u)+(g||q?"=":"")),2===b.type&&(p+=e+","),p+=q);return p};g.expandUnnamed=
	function(b,g,k,h,l){var u="",p=g.encode;g=g.empty_name_separator;var r=!b[p].length,v,e,q,w;q=0;for(w=b.val.length;q<w;q++)l?e=f[p](b.val[q][1].substring(0,l)):r?(e=f[p](b.val[q][1]),b[p].push([2===b.type?f[p](b.val[q][0]):void 0,e])):e=b[p][q][1],u&&(u+=h),2===b.type&&(v=l?f[p](b.val[q][0].substring(0,l)):b[p][q][0],u+=v,u=k?u+(g||e?"=":""):u+","),u+=e;return u};g.noConflict=function(){h.URITemplate===g&&(h.URITemplate=b);return g};B.expand=function(b){var f="";this.parts&&this.parts.length||this.parse();
	b instanceof l||(b=new l(b));for(var k=0,h=this.parts.length;k<h;k++)f+="string"===typeof this.parts[k]?this.parts[k]:g.expand(this.parts[k],b);return f};B.parse=function(){var b=this.expression,f=g.EXPRESSION_PATTERN,k=g.VARIABLE_PATTERN,h=g.VARIABLE_NAME_PATTERN,l=[],u=0,p,r,z;for(f.lastIndex=0;;){r=f.exec(b);if(null===r){l.push(b.substring(u));break}else l.push(b.substring(u,r.index)),u=r.index+r[0].length;if(!v[r[1]])throw Error('Unknown Operator "'+r[1]+'" in "'+r[0]+'"');if(!r[3])throw Error('Unclosed Expression "'+
	r[0]+'"');p=r[2].split(",");for(var e=0,q=p.length;e<q;e++){z=p[e].match(k);if(null===z)throw Error('Invalid Variable "'+p[e]+'" in "'+r[0]+'"');if(z[1].match(h))throw Error('Invalid Variable Name "'+z[1]+'" in "'+r[0]+'"');p[e]={name:z[1],explode:!!z[3],maxlength:z[4]&&parseInt(z[4],10)}}if(!p.length)throw Error('Expression Missing Variable(s) "'+r[0]+'"');l.push({expression:r[0],operator:r[1],variables:p})}l.length||l.push(b);this.parts=l;return this};l.prototype.get=function(b){var f=this.data,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              g={type:0,val:[],encode:[],encodeReserved:[]},h;if(void 0!==this.cache[b])return this.cache[b];this.cache[b]=g;f="[object Function]"===String(Object.prototype.toString.call(f))?f(b):"[object Function]"===String(Object.prototype.toString.call(f[b]))?f[b](b):f[b];if(void 0!==f&&null!==f)if("[object Array]"===String(Object.prototype.toString.call(f))){h=0;for(b=f.length;h<b;h++)void 0!==f[h]&&null!==f[h]&&g.val.push([void 0,String(f[h])]);g.val.length&&(g.type=3)}else if("[object Object]"===String(Object.prototype.toString.call(f))){for(h in f)k.call(f,
	h)&&void 0!==f[h]&&null!==f[h]&&g.val.push([h,String(f[h])]);g.val.length&&(g.type=2)}else g.type=1,g.val.push([void 0,String(f)]);return g};f.expand=function(b,h){var k=(new g(b)).expand(h);return new f(k)};return g});
